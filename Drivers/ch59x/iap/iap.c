 ...
 * @fn      USB_DeviceInit
 *
 * @brief   Bring up the USB peripheral (endpoints, DMA buffers, pull-up).
 *          Called once from main() before entering Main_Circulation().
 *
 * @return  none
 */
void USB_DeviceInit(void)
{
    ...
    R8_USB_INT_EN = 0; /* polled, not interrupt-driven */
}
...
void myDevEP2_OUT_Deal(uint8_t l)
{
    ...
    case CMD_IAP_VERIFY:
        ...
        break;
    case CMD_IAP_END:
        /* Update finished: tear down USB and hand off to the application. */
